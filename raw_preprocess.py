...
_category = 20 # dataset class
dataset_dir = "/root/autodl-tmp/ET-datasets/datasets/USTC/" # the path to save dataset for dine-tuning

pcap_path, dataset_save_path, samples, features, dataset_level = "/root/autodl-tmp/ET-datasets/datasets/USTC/", "/root/autodl-tmp/ET-datasets/datasets/USTC/", [5000], ["payload"], "packet"
